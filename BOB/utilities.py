...
def parseConnectionArguments(parser = argparse.ArgumentParser()):
    parser.add_argument("--ip", type=str, help="IP address of destination", default="192.168.2.20")
...
class DeviceConnection:
    ...
    def __enter__(self):
        ...
        # try:
        #     print("Pushing physical payload configuration (200g)...")
        #     control_config = ControlConfigClient(self.router)
        #     payload = ControlConfig_pb2.PayloadInformation()
        #     payload.payload_mass = 0.127
        #     payload.payload_mass_center.x = 0.0      # Centered horizontally
        #     payload.payload_mass_center.y = 0.0535   # 53.5mm UP from the joint center
        #     payload.payload_mass_center.z = 0.010    # 10mm FORWARD from the flange            
        #     control_config.SetPayloadInformation(payload)
        #     print("✅ Payload set upon connection.")
        # except Exception as e:
        #     print(f"🚨 Failed to set payload during connection: {e}")
